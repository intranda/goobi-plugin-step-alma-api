...
This is the AlmaApi Goobi step plugin. It contains functionality to communicate with the ALMA REST API to create or update records and to set the workorder status.
